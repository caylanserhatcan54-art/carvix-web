...
// BURASI DEĞİŞTİ: quick -> standard
export type PackageType = "standard" | "detailed";

export type PartKey =
  | "GENEL_ON" | "GENEL_ARKA" | "GENEL_SAG" | "GENEL_SOL" | "GENEL_TAVAN"
  | "SOL_ON_KAPI" | "SOL_ARKA_KAPI" | "SAG_ON_KAPI" | "SAG_ARKA_KAPI"
  | "KAPUT" | "BAGAJ" | "SOL_ON_CAMURLUK" | "SOL_ARKA_CAMURLUK"
  | "SAG_ON_CAMURLUK" | "SAG_ARKA_CAMURLUK"
  | "KAPI_MENTESE" | "KAPI_VIDALARI" | "KAPI_DIREKLERI"
  | "KAPUT_MENTESE" | "KAPUT_VIDALARI" | "BAGAJ_MENTESE" | "BAGAJ_VIDALARI"
  | "SASE_KADRO" | "ALT_TAKIM" | "ON_SUSPANSIYON" | "ARKA_SUSPANSIYON"
  | "EGZOZ_BAGLANTI" | "SELE_ALTI" | "GRENAJ_VIDALARI" | "JANT_LASTIK";

export type PartMeta = {
  key: PartKey;
  label: string;
  group: "genel" | "panel" | "tamper" | "moto_body" | "moto_frame" | "atv_frame" | "atv_suspension";
  recommended?: boolean;
};
...
export const VEHICLE_CONFIG: Record<VehicleType, VehicleConfig> = {
  car: {
    ...
    required: {
      standard: ["GENEL_ON", "GENEL_ARKA", "GENEL_SAG", "GENEL_SOL"],
      detailed: ["GENEL_ON","GENEL_ARKA","GENEL_SAG","GENEL_SOL","SOL_ON_KAPI","SOL_ARKA_KAPI","SAG_ON_KAPI","SAG_ARKA_KAPI","KAPUT_VIDALARI","KAPI_MENTESE"],
    },
    optional: {
      standard: ["GENEL_TAVAN"],
  ...
  motorcycle: {
    ...
    title: "Motosiklet",
    parts: [...COMMON_GENERAL.filter(p => p.key !== "GENEL_TAVAN"), { key: "SASE_KADRO", label: "Şase / Kadro (yakın)", group: "moto_frame", recommended: true }, { key: "EGZOZ_BAGLANTI", label: "Egzoz Bağlantı Noktaları", group: "moto_frame", recommended: true }, { key: "SELE_ALTI", label: "Sele Altı / Bağlantılar", group: "moto_body", recommended: true }, { key: "GRENAJ_VIDALARI", label: "Grenaj Vidaları", group: "moto_body" }, { key: "JANT_LASTIK", label: "Jant / Lastik", group: "moto_body" }],
    required: {
      standard: ["GENEL_ON","GENEL_ARKA","GENEL_SAG","GENEL_SOL"],
      detailed: ["GENEL_ON","GENEL_ARKA","GENEL_SAG","GENEL_SOL","SASE_KADRO","EGZOZ_BAGLANTI","SELE_ALTI"],
    },
    optional: {
      standard: ["JANT_LASTIK"],
  ...
  atv: {
    vehicleType: "atv",
    title: "ATV",
    parts: [...COMMON_GENERAL.filter(p => p.key !== "GENEL_TAVAN"), { key: "SASE_KADRO", label: "Şase / Kadro (yakın)", group: "atv_frame", recommended: true }, { key: "ALT_TAKIM", label: "Alt Takım (yakın)", group: "atv_frame", recommended: true }, { key: "ON_SUSPANSIYON", label: "Ön Süspansiyon / Rot", group: "atv_suspension", recommended: true }, { key: "ARKA_SUSPANSIYON", label: "Arka Süspansiyon", group: "atv_suspension" }, { key: "GRENAJ_VIDALARI", label: "Grenaj Vidaları", group: "atv_frame" }, { key: "JANT_LASTIK", label: "Jant / Lastik", group: "atv_frame" }],
    required: {
      standard: ["GENEL_ON","GENEL_ARKA","GENEL_SAG","GENEL_SOL"],
